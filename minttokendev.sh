...
LEDGER_CANISTER=$(dfx canister id voice_ledger_canister)

#dfx deploy voice_index_canister --argument "(opt variant { Init = record { ledger_id = principal \"$LEDGER_CANISTER\"} })"
